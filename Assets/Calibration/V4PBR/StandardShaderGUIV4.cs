...
{
    internal class StandardShaderGUIV4 : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent metallicMapText = EditorGUIUtility.TrTextContent("Mixed Map", "Smoothness (R) Metallic (G) AO (B)");
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] props)
        {
            ...
            ShaderPropertiesGUIV4(material);
        }
        
        //————————————————————————————————————————————————————————————————————————————————————————————————————
        // GUI Detail
        public void ShaderPropertiesGUIV4(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                DoSpecularMetallicAreaV4();// BRDF Properties————————————————————————————————————————————————————
                DoNormalArea();
        ...
        void DoSpecularMetallicAreaV4()
        {
            bool hasMixedMap = false;
            hasMixedMap = metallicMap.textureValue != null;
            m_MaterialEditor.TexturePropertySingleLine(Styles.metallicMapText, metallicMap);
            int indentation = MaterialEditor.kMiniTextureFieldLabelIndentLevel + 1;
            if(!hasMixedMap)
            {
                
                m_MaterialEditor.ShaderProperty(hasMixedMap ? metallicMap : metallic, hasMixedMap ? Styles.smoothnessScaleText : Styles.metallicText, indentation);
                m_MaterialEditor.ShaderProperty(hasMixedMap ? smoothnessScale : smoothness, hasMixedMap ? Styles.smoothnessScaleText : Styles.smoothnessText, indentation);
            }
        }
