Shader "UnityShaderPool/Templates/baseCginc"
{
	Properties
	{
...
#include "baseCginc.cginc"
	...
	fixed4 frag(vertexOutput i) : COLOR
	{
		...
		//lighting
		float3 diffuseReflection = diffuse(_LightColor0,normalDirection,lightDirection);
		float3 specularReflection = specular(_LightColor0, normalDirection, lightDirection, viewDirection, _Shininess);
